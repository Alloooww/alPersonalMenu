...
print("^0[^4Author^0] ^7:^0 ^0Allooww^7")
print("^0[^2Download^0] ^7:^0 ^5https://github.com/Alloooww/alPersonalMenu^7")
print("^0[^3Discord^0] ^7:^0 ^5https://discord.gg/QpdR86sgDQ^7")
